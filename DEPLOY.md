...
автоматаар `migrate` хийж, `admin / 1234` superuser-ийг (байхгүй бол) үүсгээд, gunicorn-оор
...
- Эхний нэвтрэлтийн дараа нууц үгээ солихыг зөвлөж байна. Солисон нууц үг
  deploy хийхэд **арилахгүй**: `ensure_admin` нь админ бүртгэл байхгүй үед л
  нууц үг тавьдаг, байгаа бол зөвхөн эрхийг нь (staff/superuser/ADMIN) сэргээнэ.
- Нууц үгээ мартвал Railway-ийн web service дээр:
  `python manage.py ensure_admin --password=<шинэ> --settings=ubpm.settings.prod`
- Хэт олон удаа буруу оруулбал бүртгэл 30 минут хаагдана
  (`ACCOUNT_LOCKOUT_*`) — тэр үед зөв нууц үг ч ажиллахгүй. Хүлээх, эсвэл
  и-мэйлээр ирэх кодоор нууц үгээ сэргээвэл хаалт шууд тайлагдана.
